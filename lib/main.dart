          ...
          children: <Widget>[
            ...
            Padding(
                ...
                child: CupertinoButton.filled(
                  ...
                  onPressed: () {
                    if (localizationDelegate.currentLocale.toString() == 'es') {
                      setState(() {
                        localizationDelegate.changeLocale(Locale('en_US'));
                      });
                    } else {
                      setState(() {
                        localizationDelegate.changeLocale(Locale('es'));
                      });
                    }

                    Future.delayed(const Duration(milliseconds: 10), () {
                      setState(() {
                        print("LENGUAGE TRANSLATED");
                      });
                    });
                  },
                )),
      ...
      child: CupertinoActionSheet(
        ...
        actions: <Widget>[
          CupertinoActionSheetAction(
            ...
            onPressed: () {
              LocalizedApp.of(context).delegate.changeLocale(Locale('en_US'));
            },
          ),
          CupertinoActionSheetAction(
            ...
            onPressed: () {
              setState(() {
                LocalizedApp.of(context).delegate.changeLocale(Locale('es'));
              });
            },
          ),
        ],
